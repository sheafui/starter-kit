<x-layouts.base>
    <div class="relative z-10 mx-auto flex h-screen flex-col">
            ...
            <div class="grid grid-cols-5">
                <div class="border-base-200/30 border !border-l-0 !border-r-0 !border-t-0 border-dashed py-6"
                ...
                <div class="border-base-200/30 bg-background z-40 col-span-3 border !border-t-0 border-dashed py-10">
                </div>
                <div class="border-base-200/30 border !border-l-0 !border-r-0 !border-t-0 border-dashed py-6"
            ...
            <!-- Main Section -->
            <div class="grid grid-cols-5">
                <div class="border-base-200/30 hidden border !border-l-0 !border-r-0 border-t-0 border-dashed py-6 lg:flex"
                     style="mask: linear-gradient(to right, transparent 0%, black 80%, black 100%); -webkit-mask: linear-gradient(to right, transparent 0%, black 80%, black 100%);">
                </div>
                <!-- Form section -->
                <div
                     class="border-base-200/30 before:border-base-200/30 before: relative col-span-5 border border-t-0 border-dashed before:absolute before:-left-16 before:-top-16 before:h-32 before:w-32 before:animate-pulse before:rounded-full before:border before:border-dashed before:content-[''] lg:col-span-3 dark:before:border-white/20">
            ...
            <div class="grid grow grid-cols-5">
                <div class="border-base-200/30 hidden border !border-b-0 !border-l-0 !border-r-0 border-t-0 border-dashed py-6 lg:flex"
                     style="mask: linear-gradient(to right, transparent 0%, black 80%, black 100%); -webkit-mask: linear-gradient(to right, transparent 0%, black 80%, black 100%);">
                </div>
                <div
                     class="border-base-200/30 before:border-base-200/30 relative col-span-5 border !border-b-0 border-t-0 border-dashed py-10 before:absolute before:-right-10 before:-top-10 before:z-40 before:h-20 before:w-20 before:rotate-45 before:border before:border-dashed before:bg-background before:content-[''] lg:col-span-3 dark:before:border-white/20">
